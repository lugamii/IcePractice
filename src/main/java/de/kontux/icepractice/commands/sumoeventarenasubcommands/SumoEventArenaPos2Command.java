...
public class SumoEventArenaPos2Command implements SumoEventArenaSubcommand {
  private final Player player;
  
  private final String arenaName;
  
  public SumoEventArenaPos2Command(String arenaName, Player player) {
  ...
  public void execute() {
    ...
    if (arena != null) {
      ...
      this.player.sendMessage((new ArenaMessageRepository()).getArenaPos2Message(arena.getName()));
    } else {
